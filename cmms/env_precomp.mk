...
# Entering /b/425/buildtools/mkfile/prefix.mk

# Entering /b/425/buildtools/mkfile/defs.mk
...
# Exiting /b/425/buildtools/mkfile/defs.mk
# Entering /b/425/buildtools/mkfile/platform.mk
...
COMPOBJ64=$(ORACLE_HOME)/$(LIBDIR)/$(CCVER)/lib/v9

COMPSOBJS32=$(COMPOBJ32)/crti.o $(COMPOBJ32)/crt1.o
COMPEOBJS32=$(COMPOBJ32)/crtn.o

COMPSOBJS32INS=$(ORACLE_HOME)/lib32/$(CCVER)/lib/crti.o $(ORACLE_HOME)/lib32/$(CCVER)/lib/crt1.o
COMPEOBJS32INS=$(ORACLE_HOME)/lib32/$(CCVER)/lib/crtn.o

COMPSOBJS64=$(COMPOBJ64)/crti.o $(COMPOBJ64)/crt1.o
...
LINKEXSYSLIBS32= -R $(CLUSTERDIR)/lib:$(ORACLE_HOME)/$(LIBDIR) \
...
LINKEXSYSLIBS64= -R $(CLUSTERDIR)/lib/sparcv9:$(ORACLE_HOME)/$(LIBDIR) \
        -Y P,$(LLPPATH)$(CLUSTERDIR)/lib/sparcv9:/usr/ccs/lib/sparcv9:/usr/lib/sparcv9\
        -Qy -lc -laio $(LLIBPOSIX4) $(LLIBKSTAT)
...
NOKPIC_CCFLAGSCC=$(PROFILE) $(XS) -xchip=ultra -xarch=v8 $(LOCAL_CCFLAGSCC)
NOKPIC_CCFLAGSCC32=$(PROFILE) $(XS) -xchip=ultra -xarch=v8 $(LOCAL_CCFLAGSCC)
NOKPIC_CCFLAGSCC64=$(PROFILE) $(XS) -xarch=v9 -xchip=ultra3 -D_REENTRANT \
	-DSS_64BIT_SERVER
NOKPIC_CCFLAGSCC=$(NOKPIC_CCFLAGSCC64)


# Exiting /b/425/buildtools/mkfile/platform.mk
# Entering /b/425/buildtools/mkfile/rules.mk
 
# Exiting /b/425/buildtools/mkfile/rules.mk
# Exiting /b/425/buildtools/mkfile/prefix.mk
# Entering /b/425/ldap/exports.mk
...
# Entering /b/425/ldap/s_exports.mk


# Exiting /b/425/ldap/s_exports.mk
# Exiting /b/425/ldap/exports.mk
# Entering /b/425/encryption/exports.mk
...
# Entering /b/425/encryption/s_exports.mk

# Exiting /b/425/encryption/s_exports.mk
# Exiting /b/425/encryption/exports.mk
# Entering /b/425/network/exports.mk

# Entering /b/425/network/libnames.mk
...
# Exiting /b/425/network/libnames.mk
...
# Entering /b/425/network/adapters.mk

# Entering /b/425/network/s_adapters.mk

# Exiting /b/425/network/s_adapters.mk

# Exiting /b/425/network/adapters.mk
...
# Entering /b/425/network/s_exports.mk
...
# Exiting /b/425/network/s_exports.mk
# Exiting /b/425/network/exports.mk
# Entering /b/425/oracore/exports.mk
...
# Entering /b/425/oracore/s_exports.mk
 
# Exiting /b/425/oracore/s_exports.mk
# Exiting /b/425/oracore/exports.mk
# Entering /b/425/nlsrtl/exports.mk
...
# Entering /b/425/nlsrtl/s_exports.mk


# Exiting /b/425/nlsrtl/s_exports.mk
# Exiting /b/425/nlsrtl/exports.mk
# Entering /b/425/rdbms/exports.mk
...
# Entering /b/425/rdbms/s_exports.mk
...
# Exiting /b/425/rdbms/s_exports.mk
# Exiting /b/425/rdbms/exports.mk
# Entering /b/425/otrace/exports.mk
...
# Entering /b/425/otrace/s_exports.mk

# Exiting /b/425/otrace/s_exports.mk
# Exiting /b/425/otrace/exports.mk
# Entering /b/425/plsql/exports.mk
...
# Entering /b/425/plsql/s_exports.mk
 
# Exiting /b/425/plsql/s_exports.mk
# Exiting /b/425/plsql/exports.mk
# Entering /b/425/slax/exports.mk
...
# Entering /b/425/slax/s_exports.mk

# Exiting /b/425/slax/s_exports.mk
# Exiting /b/425/slax/exports.mk
# Entering /b/425/xdk/exports.mk
...
# Entering /b/425/xdk/s_exports.mk
 
# Exiting /b/425/xdk/s_exports.mk



# Exiting /b/425/xdk/exports.mk

# Entering /b/425/dbjava/exports.mk
...
# Exiting /b/425/dbjava/exports.mk

# Entering /b/425/ctx/exports.mk
...
# Entering /b/425/ctx/s_exports.mk
# Exiting /b/425/ctx/s_exports.mk
# Exiting /b/425/ctx/exports.mk
# Entering /b/425/javavm/exports.mk
LIBJAVAVM=$(LIBHOME)$(LIB_PREFIX)aurora.$(LIB_EXT)
LLIBJAVAVM=$(LDLIBFLAG)aurora

# Entering /b/425/javavm/s_exports.mk

# Exiting /b/425/javavm/s_exports.mk
# Exiting /b/425/javavm/exports.mk
# Entering /b/425/jis/exports.mk
# Exiting /b/425/jis/exports.mk
# Entering /b/425/jsp/exports.mk
...
# Exiting /b/425/jsp/exports.mk
# Entering /b/425/sqlplus/exports.mk
...
# Entering /b/425/sqlplus/s_exports.mk
...
# Exiting /b/425/sqlplus/s_exports.mk
# Exiting /b/425/sqlplus/exports.mk
 
# Entering /b/425/precomp/exports.mk
...
# Entering /b/425/precomp/s_exports.mk
 
# Exiting /b/425/precomp/s_exports.mk
# Exiting /b/425/precomp/exports.mk
...
# Entering /b/425/precomp/s_precomp.mk
...
CPLUSPLUS=$(CCC) -mt
CPLUS_SYS_INCLUDE='sys_include=(/opt/SUNWspro6u1/WS6U1/include/CC4,/usr/include)'
CPLUS_INCLUDE=$(I_SYM)$(PRECOMPDEMO)proc $(INCLUDE)
CPLUS_CFLAGS=-xarch=v9 $(OPTIMIZE) $(INCLUDE) -DSLTS_ENABLE -D_REENTRANT
...
RTSORA32=rtsora32$(EXE_SUFFIX)
LOC_RTSORA32=$(PRECOMPBIN)$(RTSORA32)

FC=f77
FCFLAGS=
FC_LDPATHFLAG=$(LDPATHFLAG)

CFLAGS32=$(GFLAG) $(OPTIMIZE) $(CDEBUG) $(NOKPIC_CCFLAGS32) $(KPIC_OPTION) -DPRECOMP $(PFLAGS) $(SHARED_CFLAG) $(USRFLAGS)
LFLAGS64=-xarch=v9 $(LFLAGS)
DEMO_PROC_BUILD_SHARED=$(CC) $(LFLAGS64) -o $(EXE) $(OBJS) $(LDPATHFLAG)$(LIBHOME) $(PROLDLIBS)
...
JDK_HOME=/usr/local/packages/jdk1.3.1
...
SHIPHOME_JRE_LOCATION=/usr/local/packages/jre1.1.8
...
SHIPHOME_JDK_LOCATION=/usr/local/packages/jdk1.3.1
SHIPHOME_JDK_RUNCMD=java
SHIPHOME_JDK_JDKCLASSFILE=$(SHIPHOME_JDK_LOCATION)/lib/dt.jar:$(SHIPHOME_JDK_LOCATION)/lib/tools.jar
SHIPHOME_JDK_JDBCCLASSFILE=classes12_g.zip
SHIPHOME_JDK_NLSCLASSFILE=nls_charset12.jar
SHIPHOME_JDK_SQLJCLASSFILE=runtime12.jar
SHIPHOME_JDK_SSLCLASSFILE=$$ORACLE_HOME/jlib/javax-ssl-1_2.jar:$$ORACLE_HOME/jlib/jssl-1_2.jar

LOC_PROCOB32=$(PRECOMPBIN)procob32
LOC_PROCOB18_32=$(PRECOMPBIN)procob18_32
LOC_RTSORA32=$(PRECOMPBIN)rtsora32
...
# Exiting /b/425/precomp/s_precomp.mk
# Exiting precomp.mk
# Entering /b/425/buildtools/mkfile/libclntsh.mk
...
# Exiting /b/425/buildtools/mkfile/libclntsh.mk
